...
1. Insert a code chunk, calculate and fill out following table on the statistical summary of the simulated [sample data](#data)
```{r}
...
3. Homogeneity - equality of variances <br>
Levene's Test of Equality of Variance - gives you a F statistic <br>
We want our p-value to be > 0.05! - Our variances should NOT be statistically significantly different. <br> 
```{r}
